...
public class CollectionDepositor extends Depositor
{
	...
	protected SWORDIngester initIngester(Context context, Deposit deposit, Collection collection ) throws SWORDErrorException, DSpaceSWORDException{
		return SWORDIngesterFactory.getInstance(context, deposit, collection);
	}
	
	protected boolean isSupportedMediaType(SWORDConfiguration swordConfig, Deposit deposit) throws SWORDErrorException, DSpaceSWORDException{
		return swordConfig.isSupportedMediaType(deposit.getPackaging(), this.collection);
	}
			...
			throws SWORDErrorException, DSpaceSWORDException
	{
		...
		if (!isSupportedMediaType(swordConfig, deposit))
		{
		...
		SWORDIngester si = initIngester(context, deposit, collection);
