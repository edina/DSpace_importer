...
public class DepositManager
{
	...
	protected SWORDUrlManager initUrlManager(Context context){
		return swordService.getUrlManager();
	}
			...
			throws DSpaceSWORDException, SWORDErrorException
	{
		...
		SWORDUrlManager urlManager = initUrlManager(context);
	...
	protected Depositor initCollectionDepositor(SWORDService service, DSpaceObject dso) throws DSpaceSWORDException{
		return new CollectionDepositor(swordService, dso);
	}
		...
		throws DSpaceSWORDException, SWORDErrorException, SWORDAuthenticationException
	{
		...
		if (dso instanceof Collection)
		{
			...
			dep = initCollectionDepositor(swordService, dso);
		}
		else if (dso instanceof Item)
		{
